...
include_once(get_template_directory() . "/templates/travesias_grupos.php");
include_once(get_template_directory() . "/templates/travesias_empresas.php");
include_once(get_template_directory() . "/templates/citas.php");
include_once(get_template_directory() . "/templates/equipo.php");
include_once(get_template_directory() . "/templates/contact.php");
